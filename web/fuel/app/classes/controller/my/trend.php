...
class Controller_My_Trend extends Controller_Mybase
{
    ...
    public function action_index()
    {
        ...
        $this->template->description = 'トレンド｜きん女。マイページ';
        $this->template->title = 'トレンド｜きん女。マイページ';
        $this->template->pc_header = View::forge('kinyu/common/pc_header.smarty', $this->data);
        $this->template->contents = View::forge('my/trend/index.smarty', $this->data);
