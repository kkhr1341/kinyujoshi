...
class Controller_Kinyu_Campaign extends Controller_Kinyubase
{
    ...
    public function action_kinyu_map()
    {
        ...
        $this->template->contents = View::forge('kinyu/campaign/kinyu_map.smarty', $this->data);
    }
    ...
    public function action_ooedojoshikai_2018()
    {
        ...
        $this->template->sp_footer = View::forge('kinyu/common/sp_footer.smarty', $this->data);
        $this->template->sp_navigation = View::forge('kinyu/common/sp_navigation.smarty', $this->data);
        $this->template->map_last = View::forge('kinyu/kinyu_map/map_last.smarty', $this->data);
