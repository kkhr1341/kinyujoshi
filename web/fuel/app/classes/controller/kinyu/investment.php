...
class Controller_Kinyu_Investment extends Controller_Kinyubase
{

  public function action_index($page=1) {
    
    $this->data['investment'] = Blogs::all('investment', '/blog/', $page, 2, 20);
    //$this->data['specials'] = Blogs::lists(1, 2, true, 'irodori');
    $pagination = $this->data['investment']['pagination'];
    $this->data['pagination'] = $pagination::instance('mypagination');
    $this->template->title = '投資カテゴリー・きんゆう女子。';
    $this->template->category = '投資。はじめました。';
    $this->template->description = '実際にお金を運用してみよう！投資に関するカテゴリーのコンテンツをこのページでまとめています';
    ...
    $this->template->contents = View::forge('kinyu/investment/index.smarty', $this->data);
