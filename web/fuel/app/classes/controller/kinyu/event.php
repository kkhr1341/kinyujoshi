...
//        }
    ...
    // 相談窓口
    public function action_inquiry_counter()
    {
        ...
        $this->template->contents = View::forge('kinyu/event/inquiry_counter.smarty', $this->data);
    }

    // 相談窓口
    public function action_inquiry_counter_complete()
    {
        ...
        $this->template->contents = View::forge('kinyu/event/inquiry_counter_complete.smarty', $this->data);
    }
}
