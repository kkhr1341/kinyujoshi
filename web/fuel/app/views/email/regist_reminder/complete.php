...
<head>
    ...
    <title>【きんゆう女子。】パスワードの設定が完了しました。</title>
        ...
        <td class="container" bgcolor="#FFFFFF">
            <div class="content">
                <table>
                    <tr>
                        <td>
                            <h3>パスワードの設定が完了しました。</h3>
                            パスワードの設定が完了しましたので、ご連絡いたします。<br>
                            ご設定いただき、ありがとうございます...( ´∀｀)！<br><br>
                            マイページへのログインは以下URLよりお願いいたします。<br>
                            <a href="https://kinyu-joshi.jp/my" target="_blank">https://kinyu-joshi.jp/my</a>
                        </td>
                    </tr>
                </table>
            </div>
