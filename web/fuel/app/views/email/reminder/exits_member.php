...
<head>
    ...
    <title>【きんゆう女子。】WEBアップデートに伴う、パスワード設定のお願い。</title>
                ...
                <table>
                    <tr>
                        <td>
                            ...
                            また、女子会に参加するには、新しく追加した"マイページ"へのログインが必要になります。<br>
                            そのため、メンバー登録方法もアップデートさせ、Google・Facebook・メールアドレスでのご登録が可能になりました。<br><br>

                            ただ、このメールをお送りしているみなさまは、すでにメンバー登録をいただいておりましたので、<br>
                            またご登録いただくのはお手数だと編集部では考えまして...。 <br><br>

                            パスワードの設定のみで、マイページへのログインが可能になるよう設計いたしました。<br>
                            つきましては、以下1~6の手順にて、パスワードの設定をお願いできますと嬉しいです。<br><br><br>
                            ...
                            ④ 以下URL先に移動してください。<br>
                            <a href="https://kinyu-joshi.jp/my" target="_blank">https://kinyu-joshi.jp/my</a><br><br>
