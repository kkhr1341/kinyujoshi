...
;(function($) {
	$.fn.yycountdown = function(options){
		...
		var _initTimer = function(){
			...
			var boxDay     = $('<div>').addClass('yyc-box yyc-day');
			var boxHou     = $('<span />').addClass('yyc-box yyc-hou');
			var boxMin     = $('<span />').addClass('yyc-box yyc-min');
			var boxSec     = $('<span />').addClass('yyc-box yyc-sec');
			var boxDayText = $('<span />').addClass('yyc-subbox yyc-day-text');
			var boxHouText = $('<span />').addClass('yyc-subbox yyc-hou-text');
			var boxMinText = $('<span />').addClass('yyc-subbox yyc-min-text');
			var boxSecText = $('<span />').addClass('yyc-subbox yyc-sec-text');
